...
/**
 * hte_expedition_workflow
 *
 * @ORM\Table(name="hte_expedition_workflow")
 * @ORM\Entity(repositoryClass="AdminBundle\Repository\hte_expedition_workflowRepository")
 */
class Hte_expedition_workflow
{
    /**
     * @var int
     *
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="created_by", type="date")
     */
    private $createdBy;
     ...
     *
     * @return hte_expedition_workflow
     */
