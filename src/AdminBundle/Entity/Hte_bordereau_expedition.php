...
/**
 * hte_bordereau_expedition
 *
 * @ORM\Table(name="hte_bordereau_expedition")
 * @ORM\Entity(repositoryClass="AdminBundle\Repository\hte_bordereau_expeditionRepository")
 */
class Hte_bordereau_expedition
{
    /**
     * @var int
     *
     ...
     * @param string $code
     *
     * @return hte_bordereau_expedition
     */
