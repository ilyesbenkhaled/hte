...
/**
 * hte_bordereau_pickup
 *
 * @ORM\Table(name="hte_bordereau_pickup")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\hte_bordereau_pickupRepository")
 */
class hte_bordereau_pickup
{
    /**
     * @var int
     *
