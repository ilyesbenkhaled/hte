 ...
 * hte_pickup_package
 *
 * @ORM\Table(name="hte_pickup_package")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\hte_pickup_packageRepository")
 */
class hte_pickup_package
{
    /**
     * @var int
     *
