...
/**
 * hte_expedition_package_archive
 *
 * @ORM\Table(name="hte_expedition_package_archive")
 * @ORM\Entity(repositoryClass="AdminBundle\Repository\hte_expedition_package_archiveRepository")
 */
class Hte_expedition_package_archive
{
    /**
     * @var int
     *
     ...
     *
     * @return hte_expedition_package_archive
     */
