...
/**
 * hte_interdepository_package_archive
 *
 * @ORM\Table(name="hte_interdepository_package_archive")
 * @ORM\Entity(repositoryClass="AdminBundle\Repository\hte_interdepository_package_archiveRepository")
 */
class Hte_interdepository_package_archive
{
    /**
     * @var int
     *
     ...
     *
     * @return hte_interdepository_package_archive
     */
