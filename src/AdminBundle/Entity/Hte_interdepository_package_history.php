...
/**
 * hte_interdepository_package_history
 *
 * @ORM\Table(name="hte_interdepository_package_history")
 * @ORM\Entity(repositoryClass="AdminBundle\Repository\hte_interdepository_package_historyRepository")
 */
class Hte_interdepository_package_history
{
    /**
     * @var int
     *
     ...
     *
     * @return hte_interdepository_package_history
     */
